...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'tang-amber/bo-api-doc', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'Amber', // 必需
      link: 'https://github.com/tang-amber', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:3245498574@qq.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/tang-amber',
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer: {
      ...
      copyrightInfo:
        'Amber | <a target="_blank" href="https://beian.miit.gov.cn/"> 蜀ICP备2024071912号-1</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
